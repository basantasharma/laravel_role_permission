            ...
            <div class="card-body p-5 text-left">
              <form action="#" method="post">
                ...
                <div class="form-outline mb-2">
                  <label class="form-label" for="typenameX-2">User Name</label>
                  <input name="username" type="text" id="typenameX-2" class="form-control form-control-md" placeholder="Radius username" value="" />
                </div>

                {{-- <div class="form-outline mb-2">
                  <label class="form-label" for="typeUserNameX-2">attribute</label>
                ...
                <div class="form-outline mb-2">
                  ...
                  <input name="password" type="password" id="typeEmailX-2" class="form-control form-control-md" placeholder="Radius password" />
                </div>
